...
function elegibleLines(numberOfGoals, allGoalsListUpdated, allAcomplishmentsListUpdated){
  const targets = [4200, 1200, 2400, 1200, 1800, 1200];
...
function generateResults(){ 
  ...
  if(alertAnswer){
    ...
    console.log(linesMultiplier, boostsMultiplier, elegibleLinesList, multipliedLines, finalValue, linesWithAccelerator);
